"""luciano_app_19530 URL Configuration
...
admin.site.site_header = "Luciano App"
admin.site.site_title = "Luciano App Admin Portal"
admin.site.index_title = "Luciano App Admin"

# swagger
api_info = openapi.Info(
    title="Luciano App API",
    default_version="v1",
    description="API documentation for Luciano App App",
)
